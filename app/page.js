      ...
      <div className='relative mx-auto flex min-h-[100dvh] w-full max-w-[1280px] flex-col px-4 py-8 sm:px-6 sm:py-10 md:px-8 md:py-14'>
        <div className='mx-auto flex max-w-4xl flex-col items-center text-center'>
          <Link aria-label='Go to home screen' href='/'>
            <Image
              alt='Pokopia logo'
              className='h-60 w-60 rounded-2xl border border-[#3a3a5c] bg-[rgba(255,255,255,.03)] object-contain p-2 shadow-[0_20px_65px_rgba(0,0,0,.42)] sm:h-80 sm:w-80 lg:h-100 lg:w-100'
              height={420}
              priority
        ...
        <section className='mt-10 grid gap-4 sm:mt-12 md:grid-cols-3 md:gap-5 lg:mt-14 lg:gap-6'>
          ...
          >
            <Image
              alt='Block Builder icon'
              className='h-12 w-12 rounded-md border border-[#3a3a5c] bg-[rgba(255,255,255,.03)] object-contain p-1'
              height={48}
              src='/images/items/brick.png'
              unoptimized
              width={48}
            />
            <p className='text-[13px] font-semibold uppercase tracking-[0.14em] text-[#8da2ce]'>
              Section 01
            </p>
            <h2 className='mt-2 text-2xl font-bold text-[#e8eeff]'>
              Block Builder
            </h2>
            <p className='mt-2 text-[15px] leading-relaxed text-[#a8b6d6]'>
              Create layered structures with blocks, doors, windows, and roof
              parts.
            </p>
          </Link>
          ...
          >
            <Image
              alt='Items Explorer icon'
              className='h-12 w-12 rounded-md border border-[#3a3a5c] bg-[rgba(255,255,255,.03)] object-contain p-1'
              height={48}
              src='/images/tags/decoration.png'
              unoptimized
              width={48}
            />
            <p className='text-[13px] font-semibold uppercase tracking-[0.14em] text-[#8da2ce]'>
          ...
          >
            <Image
              alt='Pokemon Explorer icon'
              className='h-12 w-12 rounded-md border border-[#3a3a5c] bg-[rgba(255,255,255,.03)] object-contain p-1'
              height={48}
              src='/images/items/pikachudoll.png'
              unoptimized
              width={48}
            />
            <p className='text-[13px] font-semibold uppercase tracking-[0.14em] text-[#8da2ce]'>
